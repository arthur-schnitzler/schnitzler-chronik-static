                ...
                <div class="hfeed site" id="page">
                    ...
                    <div style="max-width: 650px;'" id="body">
                        <p class="mt-3">In den letzten Jahren wurden von mehreren
                            ...
                            digitalisiert. Neben seiner Bedeutung als literarischer Schriftsteller
                            und Dramatiker wurde und wird sein Tagebuch und seine Korrespondenz
                            zugänglich gemacht.</p>
                        <p class="mt-3">Diese Webseite stellt ein einfaches Frontend dar, über
                            welches veröffentlichte Informationen zu jedem Tag seines Lebens
                            abgerufen werden können, sowohl als HTML-Ansicht, als auch als
                            JSON-Datei: <ul>
